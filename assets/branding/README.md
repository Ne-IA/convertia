# ConvertIA — Brand assets

- **`convertia-logo.png`** — the v1 logo: three arrows forming a continuous
  **conversion loop** (blue → green → orange). The motif (cycle / convert) and the
  colour set are settled; only minor refinements are expected (style stays).

## Design guardrail (for the P8 UI work)

- The **app UI stays modern & clean — blue is the primary colour.**
