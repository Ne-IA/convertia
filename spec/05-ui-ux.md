...
| **UnsupportedNotice** (10) | full-screen state, **no** `alertdialog`; heading `aria-live="assertive"`, focusable on entry (§5.3) | heading |
...
| 10 UnsupportedNotice | assertive heading (focusable) → Dismiss button (§5.3) |
