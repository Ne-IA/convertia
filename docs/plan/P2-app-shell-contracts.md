...
- [ ] **P2.132** [RUST] Author the `Platform` enum (`Win`/`MacOS`/`Linux`) into `crate::engines/` — the §3.2-owned leaf the C11 `AppInfo` contract embeds (§7.2.3) and, from P4, the `Engine` trait / `select()` consume · §3.2.2 §0.6 · G29
  needs: P1.25
