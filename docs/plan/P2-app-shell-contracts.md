...
- [ ] **P2.133** [RUST] Promote `tokio-util` to a direct dependency (`tokio_util::sync::CancellationToken`, `tokio-util = "0.7.18"`, no extra features) in `src-tauri/Cargo.toml` + `Cargo.lock` · §0.8 §0.4.4 §1.7 · G18 G18a
  needs: P1.6
...
- [ ] **P2.134** [CI] Add `tokio-util` to `check-supply-chain`'s §0.8 `PINNED_FLOORS` (`tokio-util = 0.7.18`, g24-auto-covered like `tempfile`/`proptest`) — the §0.8 drift-floor row · §0.8 §0.4.4 · G18 G18a
  needs: P2.133
