...
- [!extern] **P5.78** [TEST] Run the phase-end Co-Pilot hardening sweep over the whole P5 delivery — adversarial re-test at the hardest technically-possible level · §6.4
  ...
  > **Second leg (§11.4, owner directive 2026-07-22):** the same sweep then pre-fill-audits the P6 plan boxes over every test-strategy §11.4 surface; §11.4 binds, this note only points; resolvable findings land as dual-reviewed plan/spec edits BEFORE the P6 build session starts, genuine forks go to the owner batched at the boundary.
