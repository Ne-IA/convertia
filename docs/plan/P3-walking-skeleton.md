...
- [!extern] **P3.82** [CI] Add `tokio` to `check-supply-chain`'s §0.8 `PINNED_FLOORS` (`tokio = 1.52.3`, g24-auto-covered like `tokio-util`/`proptest`) — the §0.8 drift-floor row for the P3.3 direct-dep promotion · §0.8 §0.9 · G18 G18a
  needs: P3.3
