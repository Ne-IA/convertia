...
(P9.35), the serde/IPC leg (P2.126), the imgworker-FFI leg (P4.35.1), and the zip-slip leg
(P7.50.1). Without it, fs_guard + CSV/TSV would have ONLY the stable replay and no box wiring
