...
- [!extern] **P10.60** [TEST] Run the phase-end Co-Pilot hardening sweep over the whole P10 delivery — adversarial re-test at the hardest technically-possible level · §6.4
  ...
  > **Second leg (§11.4, owner directive 2026-07-22):** the same sweep then pre-fill-audits the P11 plan boxes against the as-built codebase + their cited spec §§ + their dependency edges (incl. embedded-type edges plan-lint cannot see) + information-completeness + their mandate-pair & promise coverage (surface (e), added 2026-08-27); resolvable findings land as dual-reviewed plan/spec edits BEFORE the P11 build session starts, genuine forks go to the owner batched at the boundary.
