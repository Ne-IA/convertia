...
**17 classes**: `T1, T2, T2a, T2b, T2c, T3, T3a, T4, T5, T6, T7, T8, T9a, T9b, T10, T11, T12`.
...
- **§0.11 ↔ §5 parity (closed).** §5 carries one row per §0.11 class. **(FROZEN r1
  snapshot — superseded by the authoritative 17-class set in §5 / §8 / §9 / §16 / plan-lint
  ...
  **T3a** → 15; r3 added **T11** → 16; r15 added **T12** → **17**; see §8/§9/§16) — each naming a primary control
